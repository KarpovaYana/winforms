        ...
        private void pictureBox1_MouseUp(object sender, MouseEventArgs e)
        {
            if (TText)
            {
                ...
                if (RGBflag == 1 || RGBflag == 0)
                    part2.DrawString(textBox2.Text, new System.Drawing.Font("Arial", Convert.ToInt32(textBox3.Text), FontStyle.Bold), new SolidBrush(Color.Red), new RectangleF(begin_text_x, begin_text_y, size_text_x, size_text_y), new StringFormat(StringFormatFlags.NoWrap)); // наносим на эту часть текст с параметрами
                else if (RGBflag == 2)
                    part2.DrawString(textBox2.Text, new System.Drawing.Font("Arial", Convert.ToInt32(textBox3.Text), FontStyle.Bold), new SolidBrush(Color.Green), new RectangleF(begin_text_x, begin_text_y, size_text_x, size_text_y), new StringFormat(StringFormatFlags.NoWrap)); // наносим на эту часть текст с параметрами
                else if (RGBflag == 3)
                    part2.DrawString(textBox2.Text, new System.Drawing.Font("Arial", Convert.ToInt32(textBox3.Text), FontStyle.Bold), new SolidBrush(Color.Blue), new RectangleF(begin_text_x, begin_text_y, size_text_x, size_text_y), new StringFormat(StringFormatFlags.NoWrap)); // наносим на эту часть текст с параметрами
                pictureBox1.Image = a;
